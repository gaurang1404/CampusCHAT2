...
export const Hero = () => {
    return (
        <div>
            <div className='min-w-full lg:max-w-7xl p-4 mb-10 mx-auto flex flex-col justify-center gap-4'>
                <div className='flex flex-col items-center gap-4 w-full mx-auto pt-4'>
                    ...
                    <div>
                        <h1><span className='text-5xl md:text-7xl font-extrabold text-[black] stroke-text'>Campus</span><span className='text-[#0B2F9F] text-6xl md:text-8xl font-extrabold'>CHAT</span></h1>
                    </div>
                    <div>
